function attachPostCreateValidation(root){
  root = root || document;
  var form = root.querySelector('#create-post-form');
  if (!form) return;
...
document.addEventListener('DOMContentLoaded', function(){ attachPostCreateValidation(document); });
window.attachPostCreateValidation = attachPostCreateValidation;
