...
class EventC {
    ...
    public function addEvent($event) {
        ...
        try {
            $req = $db->prepare(
                'INSERT INTO event (titre_event, description_event, type_event, date_debut, date_fin, lieu_event, capacite_max, statut, id_org)
                 VALUES (:titre_event, :description_event, :type_event, :date_debut, :date_fin, :lieu_event, :capacite_max, :statut, :id_org)'
            );
