...
<main class="container fo-page">
    ...
    <div class="fo-track-estimate" role="status" style="margin-top:-8px">
    ...
    <form method="get" class="fo-filters" action="mesCommandes.php" aria-label="Filtres mes commandes">
        ...
        <div class="fo-filters__actions">
            ...
            <a href="mesCommandes.php<?= $newId > 0 ? '?new=' . $newId : '' ?>" class="fo-btn fo-btn--secondary" style="text-decoration:none">Réinitialiser</a>
        </div>
    </form>
    <?php if ($q !== '' || $statut !== ''): ?>
